...
import (
	...
	"encoding/hex"
	"fmt"
	"github.com/heimuya/joy4/utils/bits/pio"
	"github.com/heimuya/joy4/av"
	"github.com/heimuya/joy4/av/avutil"
	"github.com/heimuya/joy4/codec"
	"github.com/heimuya/joy4/codec/aacparser"
	"github.com/heimuya/joy4/codec/h264parser"
	"github.com/heimuya/joy4/format/rtsp/sdp"
	"io"
	"net"
	"net/textproto"
	"net/url"
...
func Dial(uri string) (self *Client, err error) {
	return DialTimeout(uri, 3 * time.Second)
}
